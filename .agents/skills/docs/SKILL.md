...
- ✅ **Ubicación**: Guardar SIEMPRE la documentación generada automáticamente en la ruta absoluta `e:\Documentos\Proyectos\GrupoXpert\docs\use-cases\` sin preguntar al usuario.
