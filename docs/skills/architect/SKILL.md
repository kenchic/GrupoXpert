...
# Objetivo
Transformar requerimientos en un diseño estructural de Dominio (DDD) alineado con la **Arquitectura Limpia** de {ProjectName}, utilizando nomenclatura 100% en ESPAÑOL.
...
- Debes usar las herramientas a tu disposición (`write_to_file`, `replace_file_content`) para **crear o modificar físicamente los archivos `.cs`** dentro de la carpeta `Src/{ProjectName}/{ProjectName}.Domain/`.
